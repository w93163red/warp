...
# Exclude the ctrl-t external handoff helper (see warp_run_external_ctrl_t_widget above) from
# the user's history.
#
...
# already our own wrapper from a previous run (identified by the warp_run_external_ctrl_t_widget
...
if functions -q fish_should_add_to_history
  and not functions fish_should_add_to_history | string match --quiet -- '*warp_run_external_ctrl_t_widget*'
