...
fn names_the_model_reported_for_the_exchange() {
    ...
    assert_eq!(
        ...
        Some(WarpingModelMessage {
            text: "Working with Claude Sonnet 4.5...".to_owned(),
...
fn names_a_fallback_model_without_the_naming_flag() {
    ...
    assert_eq!(
        ...
        Some(WarpingModelMessage {
            text: "Working with Claude Haiku 4.5.".to_owned(),
...
fn ends_the_fallback_message_in_a_period_and_the_named_message_in_an_ellipsis() {
    ...
    assert_eq!(
        ...
        Some("Working with Claude Haiku 4.5.")
    );
    assert_eq!(
        named_text.as_deref(),
        Some("Working with Claude Haiku 4.5...")
...
/// covers what an empty display name renders as: "Working with ." before the
