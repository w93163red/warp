//! AI Assistant has since been renamed to "lx-term AI" in the product.
...
pub const AI_ASSISTANT_FEATURE_NAME: &str = "lx-term AI";
pub const ASK_AI_ASSISTANT_TEXT: &str = "Ask lx-term AI";
