...
const SHOW_SSH_COMMAND_BLOCKS_MENU_ITEM_NAME: &str = "Show lx-termified SSH Blocks";
const HIDE_SSH_COMMAND_BLOCKS_MENU_ITEM_NAME: &str = "Hide lx-termified SSH Blocks";
...
fn make_new_app_menu(ctx: &AppContext) -> Menu {
    ...
    menu_items.push(MenuItem::Custom(CustomMenuItem::new(
        "Set lx-term as Default Terminal",
        move |ctx| {
...
fn make_new_help_menu() -> Menu {
    Menu::new(
        ...
        vec![
            feedback_menu_item(),
            link_menu_item("lx-term Documentation...", links::USER_DOCS_URL.into()),
            link_menu_item("GitHub Issues...", links::GITHUB_ISSUES_URL.into()),
            link_menu_item("lx-term Slack Community...", links::SLACK_URL.into()),
        ],
    )
}
