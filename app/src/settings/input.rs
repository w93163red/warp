...
define_settings_group!(InputSettings,
    settings: [
        ...
        search_atuin_history: SearchAtuinHistory {
            type: bool,
            default: true,
            supported_platforms: SupportedPlatforms::ALL,
            sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
            private: false,
            toml_path: "terminal.input.search_atuin_history",
            description: "Whether commands recorded by atuin are included in command search. Has no effect if atuin is not set up.",
        },
