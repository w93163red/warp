...
unsafe extern "C" {
    ...
    fn set_titlebar_drag_at_bottom(window: &NSWindow, enabled: Bool);
}
...
impl WindowState {
    ...
    fn set_titlebar_drag_at_bottom(&self, enabled: bool) {
        // SAFETY: `set_titlebar_drag_at_bottom` reads the window for the duration of the call.
        unsafe {
            set_titlebar_drag_at_bottom(self.window(), Bool::new(enabled));
        }
    }
}
